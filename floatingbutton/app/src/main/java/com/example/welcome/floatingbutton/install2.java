        ...
        try{
            ...
            if (scanningResult != null) {
                ...
                try {
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "https://techwhiz.puritan53.hasura-app.io/inventory/install/barcode",body, new Response.Listener<JSONObject>() {
                        @Override
